...
data_dict = {
    ...
    "openmlcroissant": pd.read_csv(DATA_PATH.joinpath("openmlcroissant_input.csv")),
}

# Import datasets here for running the Local version
IMAGE_DATASETS = "mnist_3000"
WORD_EMBEDDINGS = "openmlcroissant"
            ...
            html.Div(
                ...
                children=[
                    html.Div(
                        [
                            html.Img(
                                src=app.get_asset_url("croissant-logo.png"),
                                className="logo",
                                id="plotly-image",
                            )
                        ],
                            ...
                            Card(
                                [
                                    dcc.Dropdown(
                                        ...
                                        options=[
                                            {
                                                "label": "openml croissant",
                                                "value": "openmlcroissant",
                                            },
                                        ],
