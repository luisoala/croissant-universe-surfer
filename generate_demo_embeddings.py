...
#datasets = ["wikipedia_3000", "twitter_3000", "crawler_3000", "openmlcroissant"]
datasets = ["openmlcroissant"]
#iterations_ls = [250, 500, 750, 1000]
iterations_ls = [250, 1000]
#perplexity_ls = [3, 10, 30, 50, 100]
perplexity_ls = [3, 50]
#pca_dim_ls = [25, 50, 100]
pca_dim_ls = [25, 100]
#learning_rate_ls = [10, 50, 100, 200]
learning_rate_ls = [10, 200]
...
def generate_embedding(
    ...
    if os.path.exists(path):
        if os.path.exists(str(path) + str(DATA_PATH.joinpath(f".csv"))):
    ...
    print(str(path) + str(DATA_PATH.joinpath(f".csv")))
    print(str(DATA_PATH.joinpath(f".csv")))
    #embedding_df.to_csv(str(path) + str(DATA_PATH.joinpath(f".csv")))
    embedding_df.to_csv(str(path) + "/data.csv")
